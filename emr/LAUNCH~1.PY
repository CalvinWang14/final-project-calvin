...
def parse_args():
    ...
    p.add_argument("--start-from", type=int, default=1,
                   help="Step number to start from (1-8). Skips earlier steps.")
    return p.parse_args()
...
def main():
    ...
    steps = [
        ...
        make_spark_step(
            ...
            ["--manifest", s3out("segments") + f"{crawl}/",
    ...
    print(f"\nEMR cluster launched: {cluster_id} (starting from step {args.start_from})")
